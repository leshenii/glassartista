                ...
                <div
                    ...
                    <div
                        ...
                        <p className="text-sm lg:text-xl text-justify paragraph--p1">A Diósgyőri vár szomszédságában található Magnólia
                            ...
                            lámpák helyreállítása és restaurálása is a munkánk része.</p>
                        <div><Link href="/magnoliatiffanystudio"><Button className="light" variant="faded"
                                                                         startContent={<BsLampFill size={20}/>}>Tovább
                            a weboldalra</Button></Link></div>
                ...
                <div
                    ...
                    <div
                        ...
                        <p className="text-sm lg:text-xl text-justify paragraph--p1">Cégünk teljeskörű megoldást kínál épület- és
                            ...
                            évtizedes szakmai múltra tekint vissza. Amit nyújtunk: mérnöki tervezés, legmagasabb
                            minőségű művészeti üvegek és alapanyagok felhasználása, professzionális kivitelezés.</p>
                        <div><Button className="light" isDisabled variant="faded"
                                     startContent={<GiWindowBars size={20}/>}>Fejlesztés alatt</Button></div>
                    </div>
                </div>
            </div>
        </div>
